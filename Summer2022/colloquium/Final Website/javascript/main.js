...
btn.onclick = function() {
    ...
    let marker1 = new mapboxgl.Marker()
        ...
        popup1.setHTML(
        "<img src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/9-DeKalb-Rendering.jpg' style='width:400px;'><br>"+
        ...
        "<div id='answer1'><img id='image1' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/9DeKalb/Summer%20GIF.gif'; /><br><b>Max Shade Lost:</b> .73 hours<br><b>Average Shade Change:</b> +.15 hours<br><b>Avg % Difference in Shade:</b> +1%<br><b>Difference in % Below 11 Shaded Hours:</b> -1%</div>"+
        "<div id='answer2' hidden><img id='image1' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/9DeKalb/Winter%20GIF.gif'; /><br><b>Max Sunlight Lost:</b> 3.1 hours<br><b>Average Sunlight Change:</b> -.15 hours<br><b>Avg % Difference in Sunlight:</b> -1%<br><b>Difference in % Below 3 Sunlit Hours:</b> 0.7%</div>"+
    ...
    let marker2 = new mapboxgl.Marker()
        ...
        popup2.setHTML(
        "<img src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Side%20View%20(Credit%20-%20Peebles%20Corporation).jpeg.webp' style='width:400px;'><br>"+
        ...
        "<option id='option3' value='3'>Estimated Rent Increase</option>"+
        "<option id='option4' value='4'>Change in Avg Local Building Age</option></select>"+
        "<div id='answer1'><img id='image4' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/Hudson%20Yards/Summer%20GIF.gif'; /><br><b>Max Shade Lost:</b> 0 hours<br><b>Average Shade Change:</b> +0.35 hours<br><b>Avg % Difference in Shade:</b> +2.4%<br><b>Difference in % Below 11 Shaded Hours:</b> -4.8%</div>"+
        "<div id='answer2' hidden><img id='image4' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/Hudson%20Yards/Winter%20GIF.gif'; /><br><b>Max Sunlight Lost:</b> 5.2 hours<br><b>Average Sunlight Change:</b> -0.17 hours<br><b>Avg % Difference in Sunlight:</b> -1.2%<br><b>Difference in % Below 3 Sunlit Hours:</b> +1.9%</div>"+
        ...
        popup5.setHTML(
        "<img src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Tower-Fifth-e1547864911789.png' style='width:400px;'><br>"+
        ...
        "<option id='option3' value='3'>Estimated Rent Increase</option>"+
        "<option id='option4' value='4'>Change in Avg Local Building Age</option></select>"+
        "<div id='answer1'><img id='image4' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/E%2051/Summer%20GIF.gif'; /><br><b>Max Shade Lost:</b> 7.3 hours<br><b>Average Shade Change:</b> -0.19 hours<br><b>Avg % Difference in Shade:</b> +1.3%<br><b>Difference in % Below 11 Shaded Hours:</b> -0.6%</div>"+
        "<div id='answer2' hidden><img id='image4' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/E%2051/Winter%20GIF.gif'; /><br><b>Max Sunlight Lost:</b> 7.8 hours<br><b>Average Sunlight Change:</b> -0.13 hours<br><b>Avg % Difference in Sunlight:</b> -0.9%<br><b>Difference in % Below 3 Sunlit Hours:</b> 0.8%</div>"+
    ...
    let marker3 = new mapboxgl.Marker()
        ...
        popup3.setHTML(
        "<img src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/1x-1.jpg' style='width:400px;'><br>"+
        ...
        "<option id='option3' value='3'>Estimated Rent Increase</option>"+
        "<option id='option4' value='4'>Change in Avg Local Building Age</option></select>"+
        "<div id='answer1'><img id='image4' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/Grand%20Central/Summer%20GIF.gif'; /><br><b>Max Shade Lost:</b> 0 hours<br><b>Average Shade Change:</b> +0.26 hours<br><b>Avg % Difference in Shade:</b> +1.7%<br><b>Difference in % Below 11 Shaded Hours:</b> -1.2%</div>"+
        "<div id='answer2' hidden><img id='image4' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/Grand%20Central/Winter%20GIF.gif'; /><br><b>Max Sunlight Lost:</b> 9.3 hours<br><b>Average Sunlight Change:</b> -0.31 hours<br><b>Avg % Difference in Sunlight:</b> -2.0%<br><b>Difference in % Below 3 Sunlit Hours:</b> +2.5%</div>"+
    ...
    let marker4 = new mapboxgl.Marker()
        ...
        popup4.setHTML(
        "<img src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Cam_03_1.jpg' style='width:400px;'><br>"+
        ...
        "<option id='option3' value='3'>Estimated Rent Increase</option>"+
        "<option id='option4' value='4'>Change in Avg Local Building Age</option></select>"+
        "<div id='answer1'><img id='image4' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/45%20Broad/Summer%20GIF.gif'; /><br><b>Max Shade Lost:</b> 2.19 hours<br><b>Average Shade Change:</b> -0.04 hours<br><b>Avg % Difference in Shade:</b> +0.3%<br><b>Difference in % Below 11 Shaded Hours:</b> -0.3%</div>"+
        "<div id='answer2' hidden><img id='image4' style='width:400px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/Summer2022/colloquium/Final%20Website/Building%20Images/45%20Broad/Winter%20GIF.gif'; /><br><b>Max Sunlight Lost:</b> 3.1 hours<br><b>Average Sunlight Change:</b> -0.06 hours<br><b>Avg % Difference in Sunlight:</b> -0.4%<br><b>Difference in % Below 3 Sunlit Hours:</b> 0.03%</div>"+
