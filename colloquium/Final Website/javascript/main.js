...
btn.onclick = function() {
    ...
    let marker2 = new mapboxgl.Marker()
        ...
        "<option id='option3' value='3'>Estimated Rent Increase</option>"+
        "<option id='option4' value='4'>Change in Avg Local Building Age</option></select>"+
        "<div id='answer1'><img id='image4' style='width:200px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/colloquium/Final%20Website/Building%20Images/45%20Broad/Summer%20GIF.gif'; /><br><b>Max Shade Lost:</b> 0 hours<br><b>Average Shade Change:</b> +0.35 hours<br><b>Avg % Difference in Shade:</b> +2.4%<br><b>Difference in % Below 11 Shaded Hours:</b> -4.8%</div>"+
        "<div id='answer2' hidden><img id='image4' style='width:200px;' src='https://raw.githubusercontent.com/ljc2177/potential-octo-engine/main/colloquium/Final%20Website/Building%20Images/45%20Broad/Winter%20GIF.gif'; /><br><b>Max Sunlight Lost:</b> 5.2 hours<br><b>Average Sunlight Change:</b> -0.17 hours<br><b>Avg % Difference in Sunlight:</b> -1.2%<br><b>Difference in % Below 3 Sunlit Hours:</b> +1.9%</div>"+
